...
Module CajaDeAhorroTest
    Sub main()
        ...
        Dim cuenta1 As New CajaDeAhorro(432432, 0, cliente1)
        ...
        Console.WriteLine("Capitalizar al {0}%", CajaDeAhorro.InteresMensual)
        cuenta1.Capitalizar()
        ...
        'cuenta2 = New CajaDeAhorro(54354, 0, cliente1)
        'monto = 900
